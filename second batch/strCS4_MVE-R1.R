...
setting=strsplit(setting[[1]],',')
  tryCatch({
    ...
    file=paste ("str_CS4_MVE_Row#",as.numeric(setting[[1]][11]), ".csv", sep="")
    write.csv(out,file=file,row.names=FALSE) }, error=function(e){cat("ERROR :",conditionMessage(e), "\n")})